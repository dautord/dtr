<?php
       ...
       if($result->num_rows > 0){
			...
			echo '<td colspan="7">       
			    ...
			    <button class="btn btn-primary pull-right" name="export"><span class="glyphicon glyphicon-print"></span><i class="fa fa-file-excel"></i> Export Raw Excel Attendance</button>
			    </form></td>
			  </tr>';
				echo '<td colspan="7">       
				...
				<input type="hidden" name="date1" value='.$date1.'>
				<input type="hidden" name="date2" value='.$date2.'>
				<button class="btn btn-success pull-right" name="export"><span class="glyphicon glyphicon-print"></span><i class="fa fa-file-excel"></i> Generate Attendance Report</button>
				</form></td>
			</tr>';
